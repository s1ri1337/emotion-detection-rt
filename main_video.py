...
model_emotion.load_weights('mobilenetNewV2.h5')  # Load the weights using load_weights
...
# Load the emotion detection model
model= model_creation()  # Replace with your emotion detection model creation function
model.load_weights('mobilenetNewV2.h5')  # Load the weights using load_weights
